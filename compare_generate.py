...
def generate_ap_sql_init(field_code_list,delta_tablename,tablename,date):
    ...
    file = open(config.apsql_path.format(date=date, APNAME='AP_ODS_'+tablename.replace('.','_')+'_INIT.SQL'),'w')
...
def generate_ap_sql(field_code_list,delta_tablename,tablename,date,his_tablename,primary_list):
    ...
    file = open(config.apsql_path.format(date=date, APNAME='AP_ODS_'+tablename.replace('.','_')+'.SQL'),'w')
